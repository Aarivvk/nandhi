...
#include "nandhi_msg_types/msg/detail/pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const nandhi_msg_types::msg::Pose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nandhi_msg_types::msg::Pose *>(
    untyped_ros_message);
...
{
  return &nandhi_msg_types::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
