...
static const _Orientation_type_support_symbol_names_t _Orientation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nandhi_msg_types, msg, Orientation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nandhi_msg_types, msg, Orientation)),
  }
};
...
{
  return &::nandhi_msg_types::msg::rosidl_typesupport_cpp::Orientation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nandhi_msg_types, msg, Orientation)() {
  return get_message_type_support_handle<nandhi_msg_types::msg::Orientation>();
}
