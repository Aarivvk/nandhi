...
static const _EgoState_type_support_symbol_names_t _EgoState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nandhi_msg_types, msg, EgoState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nandhi_msg_types, msg, EgoState)),
  }
};
...
{
  return &::nandhi_msg_types::msg::rosidl_typesupport_cpp::EgoState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nandhi_msg_types, msg, EgoState)() {
  return get_message_type_support_handle<nandhi_msg_types::msg::EgoState>();
}
