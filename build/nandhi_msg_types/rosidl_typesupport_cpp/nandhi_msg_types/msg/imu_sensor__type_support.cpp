...
static const _ImuSensor_type_support_symbol_names_t _ImuSensor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nandhi_msg_types, msg, ImuSensor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nandhi_msg_types, msg, ImuSensor)),
  }
};
...
{
  return &::nandhi_msg_types::msg::rosidl_typesupport_cpp::ImuSensor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nandhi_msg_types, msg, ImuSensor)() {
  return get_message_type_support_handle<nandhi_msg_types::msg::ImuSensor>();
}
