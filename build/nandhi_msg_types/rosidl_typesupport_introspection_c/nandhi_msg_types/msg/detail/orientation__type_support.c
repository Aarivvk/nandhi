  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  nandhi_msg_types__msg__Orientation__init(message_memory);
}

void Orientation__rosidl_typesupport_introspection_c__Orientation_fini_function(void * message_memory)
{
  nandhi_msg_types__msg__Orientation__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Orientation__rosidl_typesupport_introspection_c__Orientation_message_member_array[3] = {
  {
    "x",  // name
    ...
    offsetof(nandhi_msg_types__msg__Orientation, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nandhi_msg_types__msg__Orientation, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nandhi_msg_types__msg__Orientation, z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Orientation__rosidl_typesupport_introspection_c__Orientation_message_members = {
  ...
  3,  // number of fields
  sizeof(nandhi_msg_types__msg__Orientation),
