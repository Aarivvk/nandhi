...
static const _Orientation_type_support_symbol_names_t _Orientation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nandhi_msg_types, msg, Orientation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nandhi_msg_types, msg, Orientation)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nandhi_msg_types, msg, Orientation)() {
  return &::nandhi_msg_types::msg::rosidl_typesupport_c::Orientation_message_type_support_handle;
}
